const TerminalOverlay = () => {
  return (
    <div className="absolute bottom-0 left-0 right-0 p-4 font-bold">
      <div className="relative bg-cyber-light-gray-bg backdrop-blur-3xl border border-border rounded-lg p-3 overflow-hidden font-mono">
        {/* Status bar */}
