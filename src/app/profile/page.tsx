    ...
    <section className="relative z-10 pt-12 pb-32 flex-grow container mx-auto px-4">
      ...
      {allPlans && allPlans?.length > 0 ? (
        <div className="space-y-8">
          {/* PLAN SELECTOR */}
          <div className="relative backdrop-blur-3xl p-6 rounded-sm">
            ...
            <div className="flex flex-wrap gap-2">
              {allPlans.map((plan) => (
                ...
                >
                  {plan.name}
                  {plan.isActive && (
                    <span className="ml-2 bg-green-300/30 text-green-600 text-xs px-2 py-0.5 rounded">
                      ACTIVE
                    </span>
                  )}
                </Button>
          ...
          {currentPlan && (
            <div className="relative backdrop-blur-3xl rounded-lg p-6">
              ...
              <Tabs defaultValue="workout" className="w-full">
                <TabsList className="mb-6 w-full grid grid-cols-2 bg-cyber-terminal-bg">
                  <TabsTrigger
                    value="workout"
                    className="bg-white/20 data-[state=active]:bg-primary/70 data-[state=active]:text-black"
                  >
                      ...
                      {currentPlan.workoutPlan.exercises.map(
                        (exerciseDay, index) => (
                          <AccordionItem
                            ...
                            className="border rounded-lg bg-amber-50 overflow-hidden"
                          >
                                    ...
                                    >
                                      <div className="flex justify-between items-start mb-2">
                                        ...
                                        <div className="flex items-center gap-2">
                                          <div className="px-2 py-1 rounded bg-primary/50 text-black text-xs font-mono">
                                            {routine.sets} SETS
                                          </div>
                                          <div className="px-2 py-1 rounded bg-secondary/50 text-black text-xs font-mono">
                                            {routine.reps} REPS
                                          </div>
                                        </div>
                                      </div>
                ...
                <TabsContent value="diet">
                  <div className="space-y-4">
                    <div className="flex justify-between items-center mb-4">
                      ...
                      <div className="font-mono font-semibold text-xl text-primary">
