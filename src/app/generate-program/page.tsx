  ...
  return (
    <div className="flex flex-col min-h-screen text-foreground overflow-hidden  pb-6 pt-24">
      <div className="container mx-auto px-4 h-full max-w-5xl">
        {/* Title */}
        <div className="text-center bg-card/10 backdrop-blur-sm border border-border rounded-lg overflow-hidden mb-8">
            ...
            <div className="aspect-video flex flex-col items-center justify-center p-6 relative">
              ...
              <div className="relative size-32 mb-4">
                ...
                <div className="relative w-full h-full rounded-full bg-card flex items-center justify-center border border-border overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-b from-primary/10 to-secondary/70"></div>
                  <img
                    src="/voiceAssistantai.png"
                    alt="AI Assistant"
              ...
              {messages.map((msg, index) => (
                <div key={index} className="message-item animate-fadeIn">
                  <div className="font-semibold text-xs text-muted-foreground mb-1">
                    {msg.role === "assistant" ? "FITNUTRITION AI" : "You"}:
                  </div>
